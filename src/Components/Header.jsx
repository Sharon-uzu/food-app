...
const Header = () => {
  ...
  return (
    <header className='bg-primary shadow-lg fixed z-50 w-screen p-3 px-4 md:p-6 md:px-16'>
    ...
    {/* desktop and tablet */}
        <div className='hidden md:flex w-full h-full items-center justify-between'>
          ...
          <div className='relative'>
            ...
            className='w-7 min-w-[35px] h-7 min-h-[35px] drop-shadow-xl cursor-pointer rounded-full'
            onClick={login}
            />
              ...
              isMenu && (
                ...
                exit={{opacity: 0, scale: 0.6}}
                 className='w-40 bg-gray-50 shadow-xl rounded-lg flex flex-col absolute top-8 right-0'>
                  ...
                  {
                    user && user.email === "uzushyz@gmail.com" &&(
                      <Link to={"/createItem"}>
                        <p className=' flex items-center gap-3 cursor-pointer hover:bg-slate-100 transition-all duration-100 ease-in-out text-textColor text-base px-4 py-2'
                  ...
                  <p className=' flex items-center gap-3 cursor-pointer hover:bg-slate-100 transition-all duration-100 ease-in-out text-textColor text-base px-4 py-2' onClick={logout}>Logout <MdLogout/></p>
                </motion.div>
              )
            }
          ...
          <div className='relative'>
...

            {
              isMenu && (
                ...
                animate={{opacity: 1, scale: 1}}
                exit={{opacity: 0, scale: 0.6}}
                 className='w-44 bg-gray-50 shadow-xl rounded-lg flex flex-col absolute top-8 right-0'>
                  ...
                  <p className='m-2 p-2 rounded-md shadow-md flex justify-center bg-gray-200 items-center gap-3 cursor-pointer hover:bg-slate-300 transition-all duration-100 ease-in-out text-textColor text-base'
                    onClick={logout}
                  >Logout <MdLogout/></p>
                </motion.div>
              )
